...
const AdminEditProduct = ({
  ...
  return (
    ...
    <form className='grid p-4 gap-2  overflow-x-scroll h-full pb-5' onSubmit={handleSubmit}>
    ...
    <label htmlFor='productName'>Product Name:  </label>
      ...
      <label htmlFor='category' className='mt-3'> Category: </label>
        ...
        <label htmlFor='uploadImageInput'>
            ...
            <textarea className='h-28 bg-slate-100 border resize-none p-1' name='description' value={data.description} onChange={handleOnChange} placeholder='Enter Product Description ' rows={3}>

            </textarea>


            <button className='px-3 py-2 bg-gray-600 text-white mb-10 hover:bg-gray-900'>Update Product</button>
    </form>
    </div>
    {
      openFullScreenImage &&(
