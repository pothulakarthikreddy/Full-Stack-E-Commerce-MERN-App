   ...
   <header className='h-16 shadow-md bg-white fixed w-full z-40'>
    <div className='h-full container mx-auto flex items-center px-4 justify-between '>
      ...
      <div className='flex items-center gap-7'>
        ...
        {
          user?._id ?(
            <button onClick={handleLogout} className='px-3 py-1 rounded-full text-white bg-gray-600 hover:bg-gray-900 '>Logout</button>
          ):(
            <Link to={"/login"} className='px-3 py-1 rounded-full text-white bg-gray-600 hover:bg-gray-900 '>Login</Link>
          )
        }
