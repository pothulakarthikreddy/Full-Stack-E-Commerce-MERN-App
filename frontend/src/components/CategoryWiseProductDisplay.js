                ...
                loading ?(
                    loadingList.map((product,index)=>{
                        return(
                          ...
                          <div className='w-full  min-w-[280px]  md:min-w-[320px] max-w-[320px] md:max-w-[320px]  bg-white rounded-sm shadow '>
                    ...
                    data.map((product,index)=>{
                        return(
                          ...
                          <Link to={"/product/"+product?._id} className='w-full  min-w-[280px]  md:min-w-[320px] max-w-[320px] md:max-w-[320px]  bg-white rounded-sm shadow ' onClick={scrollTop}>
