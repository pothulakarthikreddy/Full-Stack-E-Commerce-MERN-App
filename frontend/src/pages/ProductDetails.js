            ...
            {/* product details */}
             {
                loading? (
                  ...
                  <p className='capitalize text-slate-400 bg-slate-200 minn-w-[100px] animate-pulse h-6 w-full'></p>
                  <div className='text-red-600 bg-slate-200 h-6 lg:h-8  animate-pulse flex items-center gap-1 w-full'>
                 
                  </div>
                  <div className='flex items-center gap-2 text-2xl lg:text-3xl font-medium my-1 h-6 lg:h-8animate-pulse w-full'>
                  ...
                  <div className='flex items-center gap-3 my-2'>
                    <button className='border-2 border-gray-700 rounded px-3 py-1 min-w-[120px] text-gray-700 font-medium hover:bg-gray-800 hover:text-white' onClick={(e)=> handleBuyProduct(e,data?._id)}>Buy</button>
                    <button className='border-2 border-gray-700 rounded px-3 py-1 min-w-[120px] font-medium text-white bg-gray-800 hover:text-gray-900 hover:bg-white ' onClick={(e)=>handleAddToCart(e,data?._id)}>Add to Cart</button>
                  </div>
                  <div>
